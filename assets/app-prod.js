    ...
    (function() {
        ...
        */
        ...
        Mj.prototype.aQ = function() {
            var a = this.NG("[[Perch|Clicking this launches the search interface.]]")(this.OG);
        ...
        angular.module("leanback-templates", []).run(["$templateCache", function(a) {
            ...
            a.put(H.b + "/tiles/search_tile.html", '<div class="content">  <div class="title">[[Perch|Clicking this launches the search interface.]]</div>  <div class="large-action-icon search-icon"></div>  <div class="search-tile-subtitle"></div></div>');
            ...
            a.put(H.b + "/tiles/video_tile.html", '<div>  <div class="top">    <div class="video-thumb"></div>    <div class="duration">anal</div>  </div>  <div class="bottom">    <div class="title">anal</div>    <div class="overlay">      [[Published on <span class="updated">09/11/2001</span> by <span class="name">directv</span>|Label that represents the date when a video was uploaded.]]    </div>    <div class="details">      <div class="activity"></div>      <div class="description"></div>    </div>  </div></div>');
