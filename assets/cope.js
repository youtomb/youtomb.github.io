    ...
    (function() {
        ...
        */
        ...
        Mj.prototype.aQ = function() {
            ...
            return Ac(this, a, "icon-search", "searchRow", null, "videotile")
        };
        ...
        function Pj(a, b, c, e, f, g, k, l, p) {
            ...
            this.tn = this.ub.supportsPairing && new tc(H.b + "/tiles/remote_reset_tile.html", "request-pairing", {
                bb: this.Wj.Qn().r()
            }) || null;
        ...
        d.load = function(a, b) {
            ...
            this.pD.Cc(w(function(a) {
                a ? this.qD.Qa("default", w(function(a) {
                    this.ub.Uv(a);
                    this.qy("/tiles/logout_tile.html", "request-login", c, a, b)
                }, this)) : this.qy("/tiles/login_tile.html", "request-logout", c, null, b)
            }, this))
        };
        ...
        d.bQ = function() {
            ...
            return Ac(this, a, "icon-trends", "settingsRowService", null, "videotile")
        };
        ...
        angular.module("leanback-templates", []).run(["$templateCache", function(a) {
            ...
            a.put(H.b + "/tiles/video_tile.html", '<div class="content">  <div class="title">[[Terms of Service and Privacy|Title of menu item which shows links to terms of service and privacy documents on youtube.com]]</div></div>');
            a.put(H.b + "/tiles/tos_and_privacy_tile.html", '<div>  <div style="display: visible;" ass="top">    <div class="video-thumb"></div>    <div class="duration">SBC Park in San Francisco</div>  </div>  <div class="bottom">    <div class="title">SBC Park in San Francisco</div>    <div class="overlay">      [[Published on <span class="updated">09/11/2001</span> by <span class="name">directv</span>|Label that represents the date when a video was uploaded.]]    </div>    <div class="details">      <div class="activity"></div>      <div class="description"></div>    </div>  </div></div>');
